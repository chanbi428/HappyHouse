...
//		map.put("word", obj.getWord());
	...
	public ResponseEntity<List<ShopDto>> dijkstra(@RequestBody ShopParamDto obj) throws Exception {
	...
	@GetMapping("/shops/getDongCodes/{dong}")
	public ResponseEntity<DongCodeDto> getDongCodes(@PathVariable String dong) throws Exception {
		System.out.println("getDongCodes : " + dong);
		return new ResponseEntity<DongCodeDto>(service.getDongCodes(dong), HttpStatus.OK);
	}
}

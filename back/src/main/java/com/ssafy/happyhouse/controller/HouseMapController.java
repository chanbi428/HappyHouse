...
public class HouseMapController {
	...
	@GetMapping("/aptName")
	public ResponseEntity<List<HouseInfoDto>> aptName(@RequestParam("dong") String dong) throws Exception {
		return new ResponseEntity<List<HouseInfoDto>>(haHouseMapService.getAptNameInDong(dong), HttpStatus.OK);
	}
	
	@GetMapping("/aptDeal")
	public ResponseEntity<List<HouseInfoDto>> aptDeal(@RequestParam("code") String code, @RequestParam("dong") String dong) throws Exception {
		return new ResponseEntity<List<HouseInfoDto>>(haHouseMapService.getAptDealInCode(code, dong), HttpStatus.OK);
	}

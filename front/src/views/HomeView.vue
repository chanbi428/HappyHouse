  ...
  <div>
    <div id="banner" class="container-fluid page-header py-6 wow fadeIn" data-wow-delay="0.1s">
      <div class="container text-center pt-5 pb-3">
        <h1 class="display-4 text-white animated slideInDown mb-3">HAPPY HOUSE</h1>
              ...
              >
                ...
                >
                  ...
                  <h4
                    ...
                    style="font-size: 20px; font-family: 맑은 고딕; line-height: 1.88"
                  ></h4>
                </div>
              </div>
            </div>
            ...
            <div class="row g-4 pb-6">
                ...
                <div class="fact-item bg-light rounded text-center h-100 p-5">
                  ...
                  <div v-if="this.$store.state.main.weatherIcon != ''">
                    ...
                    <h1 class="display-5 mb-0">
                      {{ Math.round(this.$store.state.main.weather.main.temp) }}°C
                    </h1>
              ...
              <div class="col-lg-6 col-md-6 wow fadeIn" data-wow-delay="0.1s">
                <div class="fact-item bg-light rounded text-center h-100 p-5">
                  <div
                    v-if="
                      this.$store.state.login.isLogin && this.$store.state.myPage.dongCode != null
                    "
                  >
                    <!-- <img :src="`${weatherIcon}`" class="f mb-4" width="30%" /> -->
                    <p>관심 지역</p>
                    ...
                    <h1 class="display-5 mb-0">
                      {{ Math.round(this.$store.state.main.likeWeather.main.temp) }}°C
                    </h1>
                    <p class="mb-2 fw-bold">
                      {{ Math.round(this.$store.state.main.likeWeather.main.temp_min) }}
                      /
                      {{ Math.round(this.$store.state.main.likeWeather.main.temp_max) }}
                    </p>
                  </div>

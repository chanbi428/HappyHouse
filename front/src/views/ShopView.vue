  ...
  <div id="SHOP-VIEW" class="m-0 p-0">
    ...
    <div class="container-fluid page-header py-6 wow fadeIn" data-wow-delay="0.1s">
      <div class="container text-center pt-5 pb-3">
        <h1 class="display-4 text-white animated slideInDown mb-3">Searching Shops</h1>
      </div>
    </div>
    <!-- Page Header End -->
        ...
        <div class="search-right">
          <div class="mt-2 mb-2 text-center">
            ...
            <div style="display: inline-block; width: 300px" class="m-2">
              <input class="form-control" type="text" placeholder="Search" v-model="word" />
            </div>
          ...
          <div style="display: inline-block" class="m-2">
            <button type="button" class="btn btn-outline-primary" @click="mst" v-if="!condition">
              최적경로탐색
            </button>
            <button
              type="button"
      ...
      <div class="content-all">
        <div class="content-left">
          <div style="height: 1000px; margin-bottom: 2%; overflow: auto">
            <b-container v-if="listGetters && listGetters.length > 0" class="bv-example-row mt-3">
              <shop-list-item
...
export default {
  ...
  methods: {
    ...
    ...mapMutations(["CLEAR_SIDO_LIST", "CLEAR_GUGUN_LIST", "CLEAR_DONG_LIST", "CLEAR_SHOP_LIST"]),
    getUserInfo() {
      if (this.$store.state.myPage.dongCode != null && this.$store.state.myPage.dongCode != "") {
    ...
    async displayPlaces(places) {
      ...
      for (var i = 0; i < places.length; i++) {
        // 마커를 생성하고 지도에 표시합니다
        var marker = this.addMarker_test(new kakao.maps.LatLng(places[i].y, places[i].x), order);
        var title = places[i].place_name;
        var shopKind = places[i].category_group_name;
        var roadAddress = places[i].address_name;
    ...
    <div class="card card-primary card-outline" style="width: 300px">
      <div class="card-body box-profile">
        ...
        <ul class="list-group list-group-unbordered mb-3" style="overflow:hidden">
          ...
          <li class="list-group-item">
            <b>주소</b> <a class="float-right">${roadAddress.substr(roadAddress.indexOf(" "))}</a>
          </li>
          <li class="list-group-item">

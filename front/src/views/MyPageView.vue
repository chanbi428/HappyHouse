        ...
        <div class="row g-5">
          <div class="col-lg-4 wow fadeInUp pt-5" data-wow-delay="0.5s">
            <div class="h-100">
              <p class="text-primary text-uppercase mb-2">
                관심지역을 설정하시면 관심지역의 추천 매물을 우측에서 확인하실 수 있습니다.
              </p>
              <br />
              <div class="row g-2 mb-4">
                ...
                <div class="col-sm-12">
                  ...
                  <span
                    class="fs-5"
                    v-if="$store.state.myPage.interestArea != 'undefined undefined undefined'"
                    >{{ $store.state.myPage.interestArea }}</span
                  ><span class="fs-5" v-else>관심지역을 등록해주세요</span>
                </div>
              </div>
              <router-link to="/userUpdate" class="btn btn-primary rounded-pill py-3 px-5" href=""
                >수정하기</router-link
              >
              &nbsp;
              <button
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            ...
            >
              ...
              <div class="position-relative mt-auto">
                <img :src="aptRandom1.img" alt="" width="389.98" height="292.48px" />
                <div class="product-overlay">
                  <a class="btn btn-lg-square btn-outline-light rounded-circle" href="/house"
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            ...
            >
              ...
              <div class="position-relative mt-auto">
                <img :src="aptRandom2.img" alt="" width="389.98" height="292.48px" />
                <div class="product-overlay">
                  <a class="btn btn-lg-square btn-outline-light rounded-circle" href="/house"
                    ><i class="fa fa-eye text-primary"></i
                  ></a>
...
export default {
  ...
  methods: {
    deleteUser() {
      var $this = this;
      this.$alertify.confirmWithTitle("회원 탈퇴", "탈퇴하시겠습니까?", function () {
        console.log("delete");
        $this.$store.dispatch("deleteUser");
        $this.$alertify.success("탈퇴되었습니다");
        $this.$router.push("/");
      });
    },
    async randomApt() {

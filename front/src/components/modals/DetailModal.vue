    ...
    <div class="modal-dialog modal-dialog-scrollable modal-xl modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" style="color: #eaa636 !important">공지사항</h5>
          <button
            type="button"
            class="btn-close"
        ...
        <div class="modal-body">
          <div class="card card-primary card-outline" style="vertical-align: baseline">
            <div class="card-header row p-0 m-0" style="height: 50px; line-height: 60px">

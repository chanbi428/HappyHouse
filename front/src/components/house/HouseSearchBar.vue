      ...
      <div class="search-all">
        ...
        <div class="search-right">
          <div class="mt-2 mb-2 text-center">
            ...
            <div v-if="searchTypeIsText" style="display: inline-block; width: 300px" class="m-2">
...
export default {
  ...
  methods: {
    ...
    ...mapActions(["getSido", "getGugun", "getDong", "getHouseList", "getHouseAll"]),
    ...
    async searchApt() {
      ...
      if (this.dongCode) {
        ...
        this.displayMarkers(this.$store.getters.getAptList);
        console.log(this.$store.getters.getAptList);
        if (this.$store.getters.getAptList.length > 0) this.map.setBounds(this.bounds);
      }
